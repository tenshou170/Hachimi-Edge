...
type LoadAssetAsyncFn = extern "C" fn(
    this: *mut Il2CppObject,
    name: *mut Il2CppString,
    type_: *mut Il2CppObject,
) -> *mut Il2CppObject;
...
type LoadFromFileInternalFn =
    extern "C" fn(path: *mut Il2CppString, crc: u32, offset: u64) -> *mut Il2CppObject;
extern "C" fn LoadFromFile_Internal(
...
pub fn LoadFromFile_Internal_orig(
    path: *mut Il2CppString,
    crc: u32,
    offset: u64,
) -> *mut Il2CppObject {
...
pub fn init(_UnityEngine_AssetBundleModule: *const Il2CppImage) {
    ...
    let Unload_addr =
        il2cpp_resolve_icall(c"UnityEngine.AssetBundle::Unload(System.Boolean)".as_ptr());
