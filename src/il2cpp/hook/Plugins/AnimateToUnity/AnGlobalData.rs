...
type GetFontFn =
    extern "C" fn(this: *mut Il2CppObject, font_name: *mut Il2CppString) -> *mut Il2CppObject;
extern "C" fn _GetFont(this: *mut Il2CppObject, font_name: *mut Il2CppString) -> *mut Il2CppObject {
    let font = Hachimi::instance()
        .localized_data
        .load()
        .load_replacement_font();
    if !font.is_null() {
        return font;
    }
...
type GetFontFromCommonFn =
    extern "C" fn(this: *mut Il2CppObject, font_name: *mut Il2CppString) -> *mut Il2CppObject;
extern "C" fn _GetFontFromCommon(
    this: *mut Il2CppObject,
    font_name: *mut Il2CppString,
) -> *mut Il2CppObject {
    let font = Hachimi::instance()
        .localized_data
        .load()
