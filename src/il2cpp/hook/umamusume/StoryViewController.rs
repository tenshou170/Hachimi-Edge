...
pub fn init(umamusume: *const Il2CppImage) {
    ...
    let GetTimeScaleByHighSpeedType_addr =
        get_method_addr(StoryViewController, c"GetTimeScaleByHighSpeedType", 0);

    new_hook!(
        GetTimeScaleByHighSpeedType_addr,
        GetTimeScaleByHighSpeedType
    );
}
